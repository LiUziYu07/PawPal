...
export const I18N = {
  "zh-CN": {
    ...
    settings: {
      ...
      optionClickMode: "按住 Option 穿透宠物",
      optionClickModeHelp: "开启后，按住 Option 键时点击会穿透宠物到下方窗口，方便点击宠物下方的链接等内容",
      customPet: "自定义",
  ...
  en: {
    ...
    settings: {
      ...
      optionClickMode: "Option Key Click-Through",
      optionClickModeHelp: "When enabled, hold Option to click through the pet to underlying windows. Drag and normal clicks work as usual without Option.",
      customPet: "Custom",
