...
clickThroughModifierKey: "穿透修饰键",
      clickThroughModifierKeyHelp: "选择按住哪个键时点击穿透宠物。选「关闭」则不启用穿透。",
      clickThroughModifierKeyNone: "关闭",
      clickThroughModifierKeyOption: "Option ⌥",
      clickThroughModifierKeyCommand: "Command ⌘",
      clickThroughModifierKeyShift: "Shift ⇧",
      clickThroughModifierKeyControl: "Control ⌃",
      customPet: "自定义",
  ...
  en: {
    ...
    settings: {
      ...
      clickThroughModifierKey: "Click-Through Key",
      clickThroughModifierKeyHelp: "Choose which modifier key to hold for click-through. Select \"Off\" to disable.",
      clickThroughModifierKeyNone: "Off",
      clickThroughModifierKeyOption: "Option ⌥",
      clickThroughModifierKeyCommand: "Command ⌘",
      clickThroughModifierKeyShift: "Shift ⇧",
      clickThroughModifierKeyControl: "Control ⌃",
